...
def responses() -> dict[str, Any]:
    return {
        ...
        "get_sellers": [{"seller_id": SELLER, "seller_state": "SP"}],
        "get_order_payments": [
            {"payment_sequential": "1", "payment_type": "credit_card", "payment_value": "16.00"}
        ],
...
def test_claim_picks_matching_episode_among_eligible_ones(tmp_path: Path) -> None:
    ...
    # a canceled order was never delivered late by anyone
    assert claimed["shipment-agent"]["shipment_analysis"]["verdict"] == "on_time"
